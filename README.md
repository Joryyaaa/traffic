...
- [x] Jeddah (Al Salamah) scenario: fetch real data + confirm it has residential buildings (`configs/city_madina_jeddah.yaml`)
- [x] Baseline scenario report across all real-data scenarios (`scripts/baseline_report.py`)
