...
Usage:
    python scripts/seed_sweep_gat.py --config configs/gat_r445_mzs1.yaml \
        --timesteps 200000 --seeds 1-5 --out runs/r445_gat_200k
"""
...
def main():
    ...
    ap.add_argument("--out", default="runs/gat_sweep")
